// Adopted from https://github.com/sindresorhus/fnv1a/blob/main/index.js
...
/** 
 * @param {string} value
 * @returns {string?} a hex string representing a fnv1a hash of the given string
 */
exports.fnv1a = function(value, {size = 32} = {}) {
	if (!FNV_PRIMES[size]) {
		throw new Error('The `size` option must be one of 32, 64, 128, 256, 512, or 1024');
	}
    let buffer = new Buffer.from(value, "utf8")
	return fnv1aUint8Array(buffer, size).toString(16);
}